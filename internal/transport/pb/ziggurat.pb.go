...
const file_ziggurat_proto_rawDesc = "" +
	"\n" +
	"\x0eziggurat.proto\x12\bziggurat\"\x8d\x06\n" +
	...
	"\aattempt\x18\x10 \x01(\x05R\aattempt\x1a6\n" +
	"\bEnvEntry\x12\x10\n" +
...
var file_ziggurat_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_ziggurat_proto_goTypes = []any{
	(*DispatchTaskRequest)(nil),  // 0: ziggurat.DispatchTaskRequest
	(*DispatchTaskResponse)(nil), // 1: ziggurat.DispatchTaskResponse
	(*TaskResultRequest)(nil),    // 2: ziggurat.TaskResultRequest
	(*TaskResultResponse)(nil),   // 3: ziggurat.TaskResultResponse
	(*PullShardRequest)(nil),     // 4: ziggurat.PullShardRequest
	(*ShardData)(nil),            // 5: ziggurat.ShardData
	(*PushShardMsg)(nil),         // 6: ziggurat.PushShardMsg
	(*PushShardHeader)(nil),      // 7: ziggurat.PushShardHeader
	(*PushShardResponse)(nil),    // 8: ziggurat.PushShardResponse
	nil,                          // 9: ziggurat.DispatchTaskRequest.EnvEntry
	nil,                          // 10: ziggurat.DispatchTaskRequest.InputRefsEntry
	nil,                          // 11: ziggurat.DispatchTaskRequest.ParamsEntry
}
var file_ziggurat_proto_depIdxs = []int32{
	9,  // 0: ziggurat.DispatchTaskRequest.env:type_name -> ziggurat.DispatchTaskRequest.EnvEntry
	10, // 1: ziggurat.DispatchTaskRequest.input_refs:type_name -> ziggurat.DispatchTaskRequest.InputRefsEntry
	11, // 2: ziggurat.DispatchTaskRequest.params:type_name -> ziggurat.DispatchTaskRequest.ParamsEntry
	7,  // 3: ziggurat.PushShardMsg.header:type_name -> ziggurat.PushShardHeader
	0,  // 4: ziggurat.ZigguratNode.DispatchTask:input_type -> ziggurat.DispatchTaskRequest
	2,  // 5: ziggurat.ZigguratNode.TaskResult:input_type -> ziggurat.TaskResultRequest
	4,  // 6: ziggurat.ZigguratNode.PullShard:input_type -> ziggurat.PullShardRequest
	6,  // 7: ziggurat.ZigguratNode.PushShard:input_type -> ziggurat.PushShardMsg
	1,  // 8: ziggurat.ZigguratNode.DispatchTask:output_type -> ziggurat.DispatchTaskResponse
	3,  // 9: ziggurat.ZigguratNode.TaskResult:output_type -> ziggurat.TaskResultResponse
	5,  // 10: ziggurat.ZigguratNode.PullShard:output_type -> ziggurat.ShardData
	8,  // 11: ziggurat.ZigguratNode.PushShard:output_type -> ziggurat.PushShardResponse
...
func file_ziggurat_proto_init() {
	...
	file_ziggurat_proto_msgTypes[6].OneofWrappers = []any{
